...
export const FormPageConteiner = styled.div`
    display: flex;
    ...
    padding: 10px;
`
export const TitleFormPage = styled.h1`
    color: #FFFDDF;
    text-align: center;
    margin-top: 20px;
`
...
export function SingBtn (){
    return(
        
        <MyBtn type="submit" variant="contained" >Enviar Candidatura</MyBtn>
